<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    ...
    <ul class="menu-inner py-1">
        ...
        <!-- datas -->
        <li class="menu-item {{ \Illuminate\Support\Facades\Route::is('datas.*') ? 'active open' : '' }}">
            <a href="javascript:void(0);" class="menu-link menu-toggle">
                <i class="menu-icon tf-icons bx bx-data bx-burst"></i>
                <div data-i18n="{{ __('menu.datas.menu') }}">{{ __('menu.datas.menu') }}</div>
            </a>
            <ul class="menu-sub">
                <li class="menu-item {{ \Illuminate\Support\Facades\Route::is('datas.student.*') ? 'active' : '' }}">
                    <a href="{{ route('datas.student.index') }}" class="menu-link">
                        <div
                            data-i18n="{{ __('menu.datas.student') }}">{{ __('menu.datas.student') }}</div>
                    </a>
                </li>
                <li class="menu-item {{ \Illuminate\Support\Facades\Route::is('datas.teacher.*') ? 'active' : '' }}">
                    <a href="{{ route('datas.teacher.index') }}" class="menu-link">
                        <div data-i18n="{{ __('menu.datas.teacher') }}">{{ __('menu.datas.teacher') }}</div>
                    </a>
                </li>
                <li class="menu-item {{ \Illuminate\Support\Facades\Route::is('datas.staff.*') ? 'active' : '' }}">
                    <a href="{{ route('datas.staff.index') }}" class="menu-link">
                        <div data-i18n="{{ __('menu.datas.staff') }}">{{ __('menu.datas.staff') }}</div>
                    </a>
                </li>
            </ul>
        </li>
             ...
             <!-- Absens -->
             <li class="menu-item {{ \Illuminate\Support\Facades\Route::is('absen.*') ? 'active open' : '' }}">
                <a href="javascript:void(0);" class="menu-link menu-toggle">
                    <i class="menu-icon tf-icons bx bx-user-pin"></i>
                    <div data-i18n="{{ __('menu.absen.menu') }}">{{ __('menu.absen.menu') }}</div>
                </a>
                {{-- absens siswa --}}
                <ul class="menu-sub">
                    <li class="menu-item {{ \Illuminate\Support\Facades\Route::is('absen.*') ? 'active' : '' }}">
                        <a href="{{ route('absen.index') }}" class="menu-link">
                            <div data-i18n="{{ __('menu.absens') }}">{{ __('menu.absens') }}</div>
                        </a>
                    </li>
                    {{-- <li class="menu-item {{ \Illuminate\Support\Facades\Route::is('agenda.outgoing') ? 'active' : '' }}">
                        <a href="{{ route('agenda.outgoing') }}" class="menu-link">
