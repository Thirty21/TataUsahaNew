                ...
                <div class="d-flex align-items-end row">
                    ...
                    <div class="col-sm-5 text-center text-sm-left">
                        <div class="card-body pb-0 px-0 px-md-4">
                            <img src="{{asset('sneat/img/Data-extraction-pana.png')}}" height="160"
                                 alt="View Badge User" data-app-dark-img="illustrations/Data-extraction-pana.png"
                                 data-app-light-img="illustrations/Data-extraction-pana.png">
                        </div>
                    </div>
                </div>
            </div>
